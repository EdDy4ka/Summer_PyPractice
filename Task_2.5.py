...
while count_loss != 3:
    ...
    heads_tails = int(input("Try to guess: heads or tails: "))

    if heads_tails == coin_toss:
        print("You guessed right!\n")
        count_win += 1
    elif heads_tails != coin_toss:
...
print("Game Results: victories =", count_win, "| defeats = ", count_loss)
